...
function generateLink(id, quality) {
    return '<a data-ep="{0}" data-qual="{1}" target="_blank" class="dlLink" href="dl-{0}-{1}.html">Lien</a>'.split('{0}').join(id).split("{1}").join(quality);
}
