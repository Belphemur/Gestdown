...
class ezSQL_mysql extends ezSQLcore
{
    ...
    function __destruct()
    {
        unset($this->dbuser,$this->dbpassword,$this->dbname,$this->dbhost);
    ...
    function connect($dbuser='', $dbpassword='', $dbhost='localhost',$dbname='')
    {
        ...
        else if ( ! $this->dbh=new mysqli($dbhost,$dbuser,$dbpassword,$dbname))
        {
    ...
    {
        return mysqli_escape_string($this->dbh,stripslashes($string));
    }
